...
BOT_TOKEN = environ.get('BOT_TOKEN', "5279011515:AAG0Fsj2VVb4KsD-C13hh_Eewc6pAyncUmU")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001512074112').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb://mongo:rrRPkNb6p2rkYfiNsrXF@containers-us-west-112.railway.app:6969")
DATABASE_NAME = environ.get('DATABASE_NAME', "careful-position")
